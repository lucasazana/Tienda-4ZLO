...
@auth
    @if(auth()->user() && auth()->user()->name === '4zlo')
        <li><a href="{{ route('admin.productos.create') }}" class="text-white hover:text-white transition px-4 py-2 text-xl font-semibold uppercase tracking-wide bg-transparent border-none focus:outline-none">Registrar producto</a></li>

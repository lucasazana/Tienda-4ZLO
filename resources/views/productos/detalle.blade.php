...
<div class="container mx-auto py-8">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-6">
            ...
            <a href="https://wa.me/51936137641?text={{ urlencode('Hola, quiero reservar el producto: ' . $producto->nombre) }}" target="_blank" class="inline-block bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded transition">Reservar por WhatsApp</a>
        </div>
    </div>
</div>
@endsection

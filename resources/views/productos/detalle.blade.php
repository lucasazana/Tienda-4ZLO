                ...
                @if($imagenes->count())
                    ...
                    @if($imagenes->count() > 1)
                        <div class="flex items-center w-full mt-2 mb-4 justify-center gap-2 relative">
                            ...
                            <div class="flex gap-2 overflow-x-auto scrollbar-thin px-2 max-w-[320px] sm:max-w-[360px] md:max-w-[400px] lg:max-w-[420px]" id="carousel-thumbs" style="scroll-snap-type: x mandatory;">
